    ...
    *********************************************************/
    ...
    public abstract class BaseData : IBaseData
    {
        ...
        *********************************************************/
        ...
        /// <summary>
        /// Reader converts each data block/line of the data source into BaseData objects. Each data type creates its own factory method, and returns a new instance of the object 
        ...
        public virtual BaseData Reader(SubscriptionDataConfig config, DataStreamReader streamReader, DateTime date, bool isLiveMode)
        {
            ...
            return Reader(config, streamReader, date, dataFeed);
        }
        ...
        /// <summary>
        /// Default base implementation: reads a line of text from the stream
        /// </summary>
        /// <param name="config">Subscription data config setup object</param>
        /// <param name="streamReader">Stream reader used to read the data</param>
        /// <param name="date">Date of the requested data</param>
        ...
        /// <returns></returns>
        public virtual BaseData Reader(SubscriptionDataConfig config, DataStreamReader streamReader, DateTime date, DataFeedEndpoint dataFeed)
        {
            if (streamReader.DataFormat != DataStreamFormat.Csv)
            {
                throw new NotSupportedException("This method is meant be called only with a CSV data stream.");
            }
