    ...
    public class LiveCustomDataSubscriptionEnumeratorFactoryTests
    {
        ...
        public class WhenCreatingEnumeratorForRestData
        {
            ...
            public void Given()
            {
                ...
                var security = new Equity(Symbols.SPY, exchangeHours, quoteCurrency, SymbolProperties.GetDefault(CashBook.AccountCurrency), new CurrencyConverter(new CashBook()));
