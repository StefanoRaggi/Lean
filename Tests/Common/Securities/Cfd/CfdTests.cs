...
namespace QuantConnect.Tests.Common.Securities.Cfd
{
    ...
    public class CfdTests
    {
        ...
        public void ConstructorExtractsQuoteCurrency()
        {
            ...
            var cfd = new QuantConnect.Securities.Cfd.Cfd(SecurityExchangeHours.AlwaysOpen(config.DataTimeZone), new Cash("EUR", 0, 0), config, symbolProperties, new CashBookCurrencyConverter(new CashBook()));
