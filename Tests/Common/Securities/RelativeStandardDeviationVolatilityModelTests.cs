...
namespace QuantConnect.Tests.Common.Securities
{
    ...
    public class RelativeStandardDeviationVolatilityModelTests
    {
        ...
        public void UpdatesAfterCorrectPeriodElapses()
        {
            ...
            var security = new Security(SecurityExchangeHours.AlwaysOpen(TimeZones.NewYork), config, new Cash("USD", 0, 0), SymbolProperties.GetDefault("USD"), new CashBookCurrencyConverter(new CashBook()));
