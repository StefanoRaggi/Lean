...
namespace QuantConnect.Lean.Engine.HistoricalData
{
    ...
    public class BrokerageHistoryProvider : SynchronizingHistoryProvider
    {
        ...
        private static Subscription CreateSubscription(HistoryRequest request, IEnumerable<BaseData> history)
        {
            ...
            var security = new Security(request.ExchangeHours, config, new Cash(CashBook.AccountCurrency, 0, 1m), SymbolProperties.GetDefault(CashBook.AccountCurrency), new CashBookCurrencyConverter(new CashBook()));
